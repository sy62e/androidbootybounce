...
and then you run locally with ```npm run dev```. additionnally you can deploy using ```npm run deploy```

# why
we love android booty. we consume android booty. we live android booty.